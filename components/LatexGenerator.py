...
class LatexGenerator:
    ...
    def get_draw_one_pin(self, start_point, final_point, latex, label):
        draws = []
    ...
    def get_draw_two_pin(self, start_point, final_point, latex, label):
        draws = []
        x1 = str(start_point.x())
        y1 = str(start_point.y())
        x2 = str(final_point.x())
    ...
    def get_draw_transistor(self, id_node, point, latex, label):
        draws = []
        ...
        draw_line_middle = '\\draw (' + node + '.'+conf[1]+') to[short] (' + str(middle.x()) + ',-' + str(middle.y()) + ');'
        draw_line_button = '\\draw (' + node + '.'+conf[2]+') to[short] (' + str(button.x()) + ',-' + str(button.y()) + ');'
    ...
    def get_draw_transformer(self, id_node, point, latex, label):
    ...
    def get_latex_full(self, draw_list, settings):
        ...
        for i in range(draw_list.__len__()):
            ...
            for j in range(draw_sublist.__len__()):
